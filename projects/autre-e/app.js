  ...
  productGrid.innerHTML = PRODUCTS.map(p => `
    <article class="product-card" data-id="${p.id}" data-cat="${p.cat}" data-reveal style="--glow-color:${CATEGORY_COLORS[p.cat]}">
      ...
      <div class="product-body">
        ...
        <button class="add-to-cart-btn" data-action="add-cart"><i data-lucide="shopping-bag"></i> Ajouter au panier</button>
      </div>
    </article>`).join("");
  ...
  quickViewCard.innerHTML = `
    ...
    <div style="padding:24px 24px 28px; display:flex; gap:22px; flex-wrap:wrap;">
      ...
      <div style="flex:1; min-width:220px;">
        ...
        <button class="add-to-cart-btn" style="max-width:220px;" data-action="modal-add"><i data-lucide="shopping-bag"></i> Ajouter au panier</button>
      </div>
    </div>`;
